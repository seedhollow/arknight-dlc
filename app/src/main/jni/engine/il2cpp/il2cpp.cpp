...
#include "il2cpp.hpp"
#define IL2CPP__TAG OBFUSCATE("il2cpp")
...
vector<string> split_string(string str, const string& token) {
...
bool Il2Cpp::Attach(const char *libname) {
    ...
    il2cpp_assembly_get_image = (const void *(*)(const void *)) get_export_function(libname, OBFUSCATE("il2cpp_assembly_get_image"));

    il2cpp_string_new = (Il2CppString *(*)(const char *)) get_export_function(libname, OBFUSCATE("il2cpp_string_new"));

    il2cpp_string_new_utf16 = (Il2CppString *(*)(const wchar_t *, int32_t)) get_export_function(libname, OBFUSCATE("il2cpp_string_new_utf16"));

    il2cpp_domain_get = (void *(*)()) get_export_function(libname, OBFUSCATE("il2cpp_domain_get"));

    il2cpp_domain_get_assemblies = (void **(*)(const void* , size_t*)) get_export_function(libname, OBFUSCATE("il2cpp_domain_get_assemblies"));

    il2cpp_image_get_name = (const char *(*)(void *)) get_export_function(libname, OBFUSCATE("il2cpp_image_get_name"));

    il2cpp_class_from_name = (void* (*)(const void*, const char*, const char *)) get_export_function(libname, OBFUSCATE("il2cpp_class_from_name"));

    il2cpp_class_get_field_from_name = (void* (*)(void*, const char *)) get_export_function(libname, OBFUSCATE("il2cpp_class_get_field_from_name"));;

    il2cpp_class_get_method_from_name = (void* (*)(void *, const char*, int)) get_export_function(libname, OBFUSCATE("il2cpp_class_get_method_from_name"));;

    il2cpp_field_get_offset = (size_t (*)(void *)) get_export_function(libname, OBFUSCATE("il2cpp_field_get_offset"));

    il2cpp_field_static_get_value = (void (*)(void*, void *)) get_export_function(libname, OBFUSCATE("il2cpp_field_static_get_value"));;

    il2cpp_field_static_set_value = (void (*)(void*, void *)) get_export_function(libname, OBFUSCATE("il2cpp_field_static_set_value"));;

    il2cpp_array_new = (void *(*)(void*, size_t)) get_export_function(libname, OBFUSCATE("il2cpp_array_new"));

    il2cpp_type_get_name = (char *(*)(void *)) get_export_function(libname, OBFUSCATE("il2cpp_type_get_name"));

    il2cpp_method_get_param = (void *(*)(void *, uint32_t)) get_export_function(libname, OBFUSCATE("il2cpp_method_get_param"));;

    il2cpp_class_get_methods = (void *(*)(void *, void **)) get_export_function(libname, OBFUSCATE("il2cpp_class_get_methods"));;

    il2cpp_method_get_name = (const char *(*)(void *)) get_export_function(libname, OBFUSCATE("il2cpp_method_get_name"));;

    il2cpp_class_get_name = (const char *(*)(void *)) get_export_function(libname, OBFUSCATE("il2cpp_class_get_name"));

    il2cpp_class_get_nested_types = (void *(*)(void *, void **)) get_export_function(libname, OBFUSCATE("il2cpp_class_get_nested_types"));

    il2cpp_object_new = (void *(*)(void *)) get_export_function(libname,OBFUSCATE("il2cpp_object_new"));
...
void Il2Cpp::GetStaticFieldValue(const char *image, const char *namespaze, const char *clazz, const char *name, void *output) {
    ...
    if(!img && Il2cppDebug) {
        IL2CPP_LOGE(OBFUSCATE("Can't find image %s!"), image);
        return;
    }
    void *klass = GetClass(image, namespaze, clazz);
    if(!klass && Il2cppDebug) {
        IL2CPP_LOGE(OBFUSCATE("Can't find class %s for field %s!"), clazz, name);
        return;
    }

    void *field = il2cpp_class_get_field_from_name(klass, name);
    if(!field && Il2cppDebug) {
        IL2CPP_LOGE(OBFUSCATE("Can't find field %s in class %s!"), name, clazz);
        return;
    }
...
void *Il2Cpp::GetClass(const char *image, const char *namespaze, const char *clazz) {
    ...
    if(!klass && Il2cppDebug) {
        IL2CPP_LOGE(OBFUSCATE("Can't find class %s!"), clazz);
        return nullptr;
    }
    ...
    if(classes.size() > 1)
    {
        ...
        if (Il2cppDebug) IL2CPP_LOGE(OBFUSCATE("Can't find subclass %s in class %s!"), classes[1].c_str(), classes[0].c_str());
        return 0;
    }
...
void *Il2Cpp::NewClassObject(const char *image, const char *namespaze, const char *clazz) {
    ...
    if(!obj && Il2cppDebug)
    {
        IL2CPP_LOGE(OBFUSCATE("Can't create object for %s"), clazz);
        return 0;
    }
...
void *Il2Cpp::GetMethodOffset(const char *image, const char *namespaze, const char *clazz, const char *name, int argsCount) {
    ...
    void *klass = GetClass(image, namespaze, clazz);
    if(!klass && Il2cppDebug) {
        IL2CPP_LOGE(OBFUSCATE("Can't find class %s for method %s!"), clazz, name);
        return 0;
    }

    void **method = (void**)il2cpp_class_get_method_from_name(klass, name, argsCount);
    if(!method && Il2cppDebug) {
        IL2CPP_LOGE(OBFUSCATE("Can't find method %s in class %s!"), name, clazz);
        return 0;
    }
...
void *Il2Cpp::GetMethodOffset(const char *image, const char *namespaze, const char *clazz, const char *name, char** args, int argsCount) {
    ...
    while(method) {
            ...
            for (int i = 0; i < argsCount; i++) {
                ...
                if (arg) {
                    ...
                    if (strcmp(tname, args[i]) == 0) {
                        ...
                        if (Il2cppDebug) IL2CPP_LOGE(OBFUSCATE("Argument at index %d didn't matched requested argument!\r\n\tRequested: %s\r\n\tActual: %s\r\nSkipping function..."), i, args[i], tname);
                        score = 0;
                        goto skip;
                    }
                }
        ...
        if(score == argsCount)
        {
            if (Il2cppDebug) IL2CPP_LOGE(OBFUSCATE("Found matched function!"));
    ...
    if (Il2cppDebug) IL2CPP_LOGE(OBFUSCATE("Cannot find function %s in class %s!"), name, clazz);
    return 0;
}
